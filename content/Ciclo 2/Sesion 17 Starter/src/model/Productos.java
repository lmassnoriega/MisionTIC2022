...
public class Productos {
    ...
    public ResultSet oneProduct(int codigo){
    ...
    public void update(int codigo){
        ...
        try {
            ...
            String actualizar = "UPDATE Productos SET nombre= '" + this.nombre 
                                + "' , p_compra= "  + this.p_compra + ", p_venta=" + this.p_venta 
                                + ", c_bodega=" + this.c_bodega + ", c_minima="  + this.c_minima 
                                + ", c_maxima=" + this.c_maxima + " WHERE codigo = " + codigo;
