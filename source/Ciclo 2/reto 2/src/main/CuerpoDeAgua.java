...
public class CuerpoDeAgua {
     ...
     * @param ircaLevel Valor de punto flotante con el valor IRCA del cuerpo de agua a crear. Este valor oscila entre 0 y 100.
     */
     ...
     * @param categoryName Representa una cadena con el nombre de la categoria. Debe estar especificado en mayusculas.
