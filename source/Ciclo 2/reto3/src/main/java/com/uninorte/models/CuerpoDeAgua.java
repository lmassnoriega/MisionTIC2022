...
public class CuerpoDeAgua extends ObjetoGeografico {
     ...
     *                   agua a crear.
     * @param ID         Identificador numerico entero del cuerpo de agua a crear.
     *                   No es autogenerado.
     * @param Municipio  Cadena de caracteres que especifica el municipio en el que
     *                   esta inscrito el cuerpo de agua a crear.
     * @param IRCA_level Valor de punto flotante con el valor IRCA del cuerpo de
     *                   agua a crear. Este valor oscila entre 0 y 100.
     */
     ...
     * 
     * @param category_name Representa una cadena con el nombre de la categoria.
     *                      Debe estar especificado en mayusculas.
